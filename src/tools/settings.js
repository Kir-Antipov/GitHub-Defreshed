...
let settings = [
    ...
    new SettingsProperty("treatTagsAsReleases", "Treat tags as realeases", "Some repositories only use pre-releases, which aren't displayed as regular releases by GitHub, so without using this option you'll see 0 as the number of releases.", true)
];

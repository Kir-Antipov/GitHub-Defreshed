...
let settings = [
    ...
    new SettingsProperty("keepProfilePageIcons", "Don't remove tab icons on the profile page", "The interface update added icons to the tabs on the profile page. I find them useful, but if you have a different opinion, you can turn them off.", true),
